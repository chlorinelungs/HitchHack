...
NEARDATA struct permonst mons_init[] = {
     ...
     * kobolds
     */
    MON2("kobold", S_KOBOLD, LVL(0, 6, 10, 0, -2), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_KOBOLD, 1, CLR_BROWN),
    ...
    */
    MON2("gnoll", S_GNOLL,
      	...
      	M3_INFRAVISION,MH_GNOLL, 20, CLR_GRAY),
...
struct permonst _mons2[] = {
    ...
    MON2("gnoll mummy", S_MUMMY, LVL(6, 12, 4, 30, -5),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_WTHR, 2, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_SILENT, MZ_HUMAN),
        MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_HOSTILE, M3_INFRAVISION, MH_UNDEAD, 20, CLR_GRAY),
    ...
    MON2("gnoll zombie", S_ZOMBIE, LVL(4, 6, 8, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_SILENT, MZ_HUMAN),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID,
        M2_STALK | M2_HOSTILE, M3_INFRAVISION,
        MH_GNOLL | MH_UNDEAD, 20, HI_DOMESTIC),
